...
courses = ReplyKeyboardMarkup(keyboard=[
    [KeyboardButton(text="⚡ Starter ⚡"), KeyboardButton(text="⚡ Front-End ⚡"), KeyboardButton(text="⚡ Back-End ⚡")],
    [KeyboardButton(text="⚡ Designer ⚡"), KeyboardButton(text="⚡ Game-Desiner ⚡"), KeyboardButton(text="⚡ Java-Script ⚡")]
...
menu_rus = ReplyKeyboardMarkup(keyboard=[
    [KeyboardButton(text="Кодинг"), KeyboardButton(text="Дизайн")],
...
food_rus = ReplyKeyboardMarkup(keyboard=[
    [KeyboardButton(text="Курсы по питону"), KeyboardButton(text="Курсы по Бэк-Энд"), KeyboardButton(text="Фронт-энд курс")],
    [KeyboardButton(text="Курсы по джава-скрипт")]
], resize_keyboard=True)
...
baskets_rus = ReplyKeyboardMarkup(keyboard=[
    [KeyboardButton(text="Купить все курсы"), KeyboardButton(text="Удалить все курсы")],
    [KeyboardButton(text="Назад")]
], resize_keyboard=True)
...
reception_rus = ReplyKeyboardMarkup(keyboard=[
    ...
    [KeyboardButton(text="Служба поддержки"), KeyboardButton(text="Изменить язык")]
], resize_keyboard=True)
...
@dp.message(F.text == "Кодинг")
async def food2_function(message: types.Message):
    await message.answer("Вы выбрали раздел кодинг", reply_markup=food_rus)
